...
// 2. AUTHENTICATION (Using "AfrylAdmin")
...
// 4. FETCH DATA (Now ordering by Priority first, then newest date)
...
<head>
    ...
    <style>
        ...
        /* New Styles for the Order Buttons */
        .order-controls { display: flex; flex-direction: column; align-items: center; gap: 4px; }
        .btn-move { color: var(--text); text-decoration: none; font-size: 0.8rem; transition: 0.3s; }
