...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .feedback-item { background: var(--card-bg); padding: 50px; border: 1px solid rgba(255,255,255,0.03); }
...
<nav>
    <h1>AFRYL LOU OKIT / PARTNER [cite: 1]</h1>
    <ul><li><a href="#hero">Overview</a></li><li><a href="#connect">Connect</a></li><li><a href="#feedback">Validation</a></li></ul>
</nav>

<section id="hero" class="hero">
    <div class="hero-text">
        [cite_start]<div style="border: 1px solid var(--gold); padding: 10px 20px; display: inline-block; color: var(--gold); margin-bottom: 25px; letter-spacing: 4px; font-weight: 800; font-size: 0.7rem;">17+ YEARS EXECUTIVE EXPERTISE [cite: 8]</div>
        [cite_start]<h2>Transforming <span>Complex</span> Financials. [cite: 10, 12]</h2>
        <p style="font-size: 1.3rem; font-weight: 300; margin-bottom: 45px; max-width: 650px; color: var(--slate);">
           [cite_start]Senior Financial Operations Partner specializing in audit-ready financials, intercompany reconciliations, and structured growth for international businesses. [cite: 10, 28]
        </p>
...
<section style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 50px; border-top: 1px solid rgba(255,255,255,0.05);">
    <div>
        <h4 style="color: var(--gold); letter-spacing: 3px; font-size: 0.8rem; margin-bottom: 20px;">01. [cite_start]MULTI-ENTITY STRUCTURE [cite: 28]</h4>
        [cite_start]<p>I specialize in bringing clarity to international portfolios across the US, Australia, and the Middle East. [cite: 8, 17]</p>
    </div>
    <div>
        <h4 style="color: var(--gold); letter-spacing: 3px; font-size: 0.8rem; margin-bottom: 20px;">02. [cite_start]AUDIT-READY BOOKS [cite: 10]</h4>
        [cite_start]<p>Transforming disorganized records into decision-ready financials every single month—no surprises. [cite: 10, 12, 13]</p>
    </div>
    <div>
        <h4 style="color: var(--gold); letter-spacing: 3px; font-size: 0.8rem; margin-bottom: 20px;">03. [cite_start]OPERATIONAL INSIGHT [cite: 14]</h4>
        [cite_start]<p>Identifying risks and inefficiencies early through budget vs. actual analysis. [cite: 15, 28]</p>
    </div>
</section>

<section style="background: rgba(255,255,255,0.01); border-top: 1px solid rgba(255,255,255,0.05);">
    [cite_start]<div style="text-align: center; margin-bottom: 40px;"><span style="color: var(--gold); letter-spacing: 5px; font-size: 0.7rem; font-weight: 800;">TECHNOLOGY INFRASTRUCTURE [cite: 29]</span></div>
    <div class="sw-grid">
        [cite_start]<div class="sw-pill"><i class="fas fa-database"></i><span>NETSUITE [cite: 30]</span></div>
        [cite_start]<div class="sw-pill"><i class="fas fa-calculator"></i><span>QUICKBOOKS [cite: 30]</span></div>
        [cite_start]<div class="sw-pill"><i class="fas fa-chart-line"></i><span>XERO [cite: 30]</span></div>
        [cite_start]<div class="sw-pill"><i class="fas fa-file-invoice-dollar"></i><span>BILL.COM / DEXT [cite: 31]</span></div>
        [cite_start]<div class="sw-pill"><i class="fas fa-credit-card"></i><span>STRIPE / VOYAGE [cite: 31]</span></div>
        [cite_start]<div class="sw-pill"><i class="fas fa-tasks"></i><span>CLICKUP / FLOQAST [cite: 31]</span></div>
    </div>
</section>
...
<section id="connect">
    <div class="glass-card">
        <div>
            ...
            [cite_start]<p style="margin: 25px 0; font-size: 1.1rem;">Secure financial partnership for international entities. [cite: 17, 18]</p>
...
<footer>
    [cite_start]<p>PH: +63 999 586 6190 [cite: 4] | [cite_start]E: afryllou.consulting@gmail.com [cite: 3]</p>
    <p style="margin-top: 20px;">&copy; <?php echo date("Y"); ?> AFRYL LOU OKIT. [cite_start]SENIOR FINANCIAL OPERATIONS PARTNER. [cite: 2]</p>
</footer>
